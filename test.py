...
class Testing(Scene):
    def construct(self):
        ...
        n_loops = 9  # number of loops
        spacing = 0.2  # space between loops
        secondary_terminal_up = Line(start=[6,2,0], end=[2.8,2,0], color=YELLOW_D)
        ...
        n_loops = 9  # number of loops
        spacing = 0.2  # space between loops
        secondary_terminal_down = Line(start=[2.8,-2,0], end=[6,-2,0], color=YELLOW_D)
        ...
        self.play(Create(l3), run_time=0.2)
        self.play(Create(l4), run_time=0.2)
        self.play(Create(l5), run_time=0.2)

        self.play(Create(a1), Create(a2), Create(a3),Create(b1), Create(b2), Create(b3), run_time=0.2)
